...
public class WeatherContract {
    ...
    // To make it easy to query for the exact data, we normalize all dates that go into the database
    // to the start of the Julian day at UTC.
    ...
    /*
        ...
        Students: This is where you will add the strings. (Similar to what has been done for
        WeatherEntry)
     */
    public static final class LocationEntry implements BaseColumns {
        public static final String TABLE_NAME = "location";

        // The location setting string is what will be sent to openweathermap as location query.
        ...
        // we store the latitude and longtitude as returned by openweathermap.
